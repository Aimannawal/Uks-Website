		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar" style="background-image: url(/dist/img/Carefy/carefy.jpg)"></span>
                          ...
                          <table class="table table-vcenter table-mobile-md card-table">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="truncated-text">{{ $obat->deskripsi_obat }}</td>
                                      <td>{{ $obat->stok }}</td>
                                      ...
                                      <td>
                                          <div class="btn-list flex-nowrap">
                                              {{-- <a href="{{ route('obats.show', $obat->id) }}" class="btn">View</a> --}}
                                              <a href="{{ route('obats.edit', $obat->id) }}" class="btn">Edit</a>
